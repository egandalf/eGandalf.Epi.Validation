...
{
    /// <summary>
    /// Matches a placed image against exact dimension (width and height) requirements.
    /// </summary>
    [AttributeUsage(AttributeTargets.Field | AttributeTargets.Property, AllowMultiple = false, Inherited = true)]
    public class ExactDimensionsAttribute : ValidationAttribute
    {
        ...
        public ExactDimensionsAttribute(int width, int height)
        {
            this.Width = width;
            this.Height = height;
        }
        ...
        {
            return $"{name} may only contain an image that is exactly {Width}px wide and {Height}px tall.";
        }
    }
}
